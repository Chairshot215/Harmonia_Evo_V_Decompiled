.class public Lcom/sqn/dcc/ScanResultExtBand;
.super Ljava/lang/Object;
.source "ScanResultExtBand.java"


# instance fields
.field public bandIdx:I
...
.method public static marshall([BLcom/sqn/dcc/ScanResultExtBand;Lcom/sqn/dcc/OutValue;)I
    .locals 6
    ...
    iget-object v2, p1, Lcom/sqn/dcc/ScanResultExtBand;->nspId:[J
    ...
    :cond_1
    iget-object v2, p1, Lcom/sqn/dcc/ScanResultExtBand;->nspName:[Lcom/sqn/dcc/StaticArray_char_128;
    ...
    iget v2, p1, Lcom/sqn/dcc/ScanResultExtBand;->cinr:I
    ...
    iget v2, p1, Lcom/sqn/dcc/ScanResultExtBand;->cinrR3:I

    int-to-long v2, v2

    invoke-static {p0, v2, v3, p2}, Lcom/sqn/dcc/Util;->Copy32ToBuffer([BJLcom/sqn/dcc/OutValue;)V

    iget-short v2, p1, Lcom/sqn/dcc/ScanResultExtBand;->chBitmap:S

    invoke-static {p0, v2, p2}, Lcom/sqn/dcc/Util;->Copy8ToBuffer([BSLcom/sqn/dcc/OutValue;)V

    iget-wide v2, p1, Lcom/sqn/dcc/ScanResultExtBand;->bsId:J
...
.method public static unmarshall([BLcom/sqn/dcc/ScanResultExtBand;Lcom/sqn/dcc/OutValue;)I
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([B",
    ...
    iput v3, p1, Lcom/sqn/dcc/ScanResultExtBand;->bandIdx:I
    ...
    iput v3, p1, Lcom/sqn/dcc/ScanResultExtBand;->freqIdx:I

    invoke-static {p0, p2}, Lcom/sqn/dcc/Util;->Copy8FromBuffer([BLcom/sqn/dcc/OutValue;)S

    move-result v3

    iput-short v3, p1, Lcom/sqn/dcc/ScanResultExtBand;->pbIdx:S

    invoke-static {p0, p2}, Lcom/sqn/dcc/Util;->Copy32FromBuffer([BLcom/sqn/dcc/OutValue;)J

    move-result-wide v3

    iput-wide v3, p1, Lcom/sqn/dcc/ScanResultExtBand;->napId:J
    ...
    iput-object v3, p1, Lcom/sqn/dcc/ScanResultExtBand;->nspId:[J
    ...
    iput-object v3, p1, Lcom/sqn/dcc/ScanResultExtBand;->nspName:[Lcom/sqn/dcc/StaticArray_char_128;
    ...
    iput v3, p1, Lcom/sqn/dcc/ScanResultExtBand;->rssi:I
    ...
    iput v3, p1, Lcom/sqn/dcc/ScanResultExtBand;->cinr:I
    ...
    iput v3, p1, Lcom/sqn/dcc/ScanResultExtBand;->cinrR1:I
    ...
    iput v3, p1, Lcom/sqn/dcc/ScanResultExtBand;->cinrR3:I

    invoke-static {p0, p2}, Lcom/sqn/dcc/Util;->Copy8FromBuffer([BLcom/sqn/dcc/OutValue;)S

    move-result v3

    iput-short v3, p1, Lcom/sqn/dcc/ScanResultExtBand;->chBitmap:S

    invoke-static {p0, p2}, Lcom/sqn/dcc/Util;->Copy64FromBuffer([BLcom/sqn/dcc/OutValue;)J

    move-result-wide v3

    iput-wide v3, p1, Lcom/sqn/dcc/ScanResultExtBand;->bsId:J
