...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput v1, p0, Landroid/filterpacks/videoproc/BackDropperFilter;->BACKGROUND_STRETCH:I

    const/4 v0, 0x1

    iput v0, p0, Landroid/filterpacks/videoproc/BackDropperFilter;->BACKGROUND_FIT:I

    iput v3, p0, Landroid/filterpacks/videoproc/BackDropperFilter;->BACKGROUND_FILL_CROP:I

    iput v3, p0, Landroid/filterpacks/videoproc/BackDropperFilter;->mBackgroundFitMode:I

    const/16 v0, 0x28

    iput v0, p0, Landroid/filterpacks/videoproc/BackDropperFilter;->mLearningDuration:I

    const/16 v0, 0xa

    iput v0, p0, Landroid/filterpacks/videoproc/BackDropperFilter;->mLearningVerifyDuration:I

    const v0, 0x3f59999a

    iput v0, p0, Landroid/filterpacks/videoproc/BackDropperFilter;->mAcceptStddev:F

    const v0, 0x3f333333

    iput v0, p0, Landroid/filterpacks/videoproc/BackDropperFilter;->mHierarchyLrgScale:F

    const v0, 0x3f19999a

    iput v0, p0, Landroid/filterpacks/videoproc/BackDropperFilter;->mHierarchyMidScale:F

    const/high16 v0, 0x3f00

    iput v0, p0, Landroid/filterpacks/videoproc/BackDropperFilter;->mHierarchySmlScale:F

    iput v4, p0, Landroid/filterpacks/videoproc/BackDropperFilter;->mMaskWidthExp:I

    iput v4, p0, Landroid/filterpacks/videoproc/BackDropperFilter;->mMaskHeightExp:I

    const/4 v0, 0x3

    iput v0, p0, Landroid/filterpacks/videoproc/BackDropperFilter;->mHierarchyLrgExp:I

    iput v3, p0, Landroid/filterpacks/videoproc/BackDropperFilter;->mHierarchyMidExp:I

    iput v1, p0, Landroid/filterpacks/videoproc/BackDropperFilter;->mHierarchySmlExp:I

    const v0, 0x3ecccccd

    iput v0, p0, Landroid/filterpacks/videoproc/BackDropperFilter;->mLumScale:F

    const v0, 0x3faccccd

    iput v0, p0, Landroid/filterpacks/videoproc/BackDropperFilter;->mChromaScale:F

    const v0, 0x3f266666

    iput v0, p0, Landroid/filterpacks/videoproc/BackDropperFilter;->mMaskBg:F

    const v0, 0x3f733333

    iput v0, p0, Landroid/filterpacks/videoproc/BackDropperFilter;->mMaskFg:F

    const/high16 v0, 0x3f80

    iput v0, p0, Landroid/filterpacks/videoproc/BackDropperFilter;->mExposureChange:F
    ...
    iput v1, p0, Landroid/filterpacks/videoproc/BackDropperFilter;->mAutoWBToggle:I

    const v0, 0x3e4ccccd

    iput v0, p0, Landroid/filterpacks/videoproc/BackDropperFilter;->mAdaptRateLearning:F
    ...
    iput v0, p0, Landroid/filterpacks/videoproc/BackDropperFilter;->mVerifyRate:F

    const/4 v0, 0x0

    iput-object v0, p0, Landroid/filterpacks/videoproc/BackDropperFilter;->mLearningDoneListener:Landroid/filterpacks/videoproc/BackDropperFilter$LearningDoneListener;

    iput-boolean v1, p0, Landroid/filterpacks/videoproc/BackDropperFilter;->mUseTheForce:Z

    iput-boolean v1, p0, Landroid/filterpacks/videoproc/BackDropperFilter;->mProvideDebugOutputs:Z

    iput-boolean v1, p0, Landroid/filterpacks/videoproc/BackDropperFilter;->mMirrorBg:Z

    iput v1, p0, Landroid/filterpacks/videoproc/BackDropperFilter;->mOrientation:I

    const-wide/16 v0, -0x1

    iput-wide v0, p0, Landroid/filterpacks/videoproc/BackDropperFilter;->startTime:J
...
.method public process(Landroid/filterfw/core/FilterContext;)V
    ...
    const-string v22, "Mask_average is %d"
