.class public final Lcom/discretix/drm/api/DxDrmFile;
.super Ljava/lang/Object;
.source "DxDrmFile.java"
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/discretix/drm/api/DxDrmFile$1;
    }
.end annotation
...
.field mDrmContent:Lcom/discretix/drm/api/IDxDrmCoreContent;


# direct methods
.method public constructor <init>(Lcom/discretix/drm/api/DxDrmFile;)V
    .locals 1
    ...
    iput-boolean v0, p0, Lcom/discretix/drm/api/DxDrmFile;->mDontDeleteDrmContent:Z

    iget-object v0, p1, Lcom/discretix/drm/api/DxDrmFile;->mDrmContent:Lcom/discretix/drm/api/IDxDrmCoreContent;

    iput-object v0, p0, Lcom/discretix/drm/api/DxDrmFile;->mDrmContent:Lcom/discretix/drm/api/IDxDrmCoreContent;

    return-void
.end method

.method public constructor <init>(Lcom/discretix/drm/api/IDxDrmCoreContent;)V
    .locals 1
    ...
    iput-object p1, p0, Lcom/discretix/drm/api/DxDrmFile;->mDrmContent:Lcom/discretix/drm/api/IDxDrmCoreContent;
...
.method private verifyRightsInner(Lcom/discretix/drm/api/EDxAutoMode;Lcom/discretix/drm/api/EDxIntent;)Lcom/discretix/drm/api/EDxVerifyStatus;
    ...
    invoke-virtual {p0, v7}, Lcom/discretix/drm/api/DxDrmFile;->getTextAttribute(Lcom/discretix/drm/api/EDxTextAttribute;)Ljava/lang/String;
    ...
    sget-object v7, Lcom/discretix/drm/api/DxDrmFile$1;->$SwitchMap$com$discretix$drm$api$EDxIntent:[I
    ...
    :goto_1
    invoke-virtual {p0, v3, v4, v0}, Lcom/discretix/drm/api/DxDrmFile;->getFlags(J[J)Lcom/discretix/drm/api/EDxDrmStatus;
    ...
    :try_start_0
    invoke-virtual {p0, v5}, Lcom/discretix/drm/api/DxDrmFile;->isSoonToBeExpired(Lcom/discretix/drm/api/EDxIntent;)Z
...
.method public SetIntent(Lcom/discretix/drm/api/EDxIntent;)Lcom/discretix/drm/api/EDxDrmStatus;
    ...
    iget-object v0, p0, Lcom/discretix/drm/api/DxDrmFile;->mDrmContent:Lcom/discretix/drm/api/IDxDrmCoreContent;

    invoke-virtual {v0, p1}, Lcom/discretix/drm/api/IDxDrmCoreContent;->SetIntent(Lcom/discretix/drm/api/EDxIntent;)Lcom/discretix/drm/api/EDxDrmStatus;
...
.method public final close()V
    ...
    iget-boolean v0, p0, Lcom/discretix/drm/api/DxDrmFile;->mDontDeleteDrmContent:Z
    ...
    invoke-virtual {v0}, Lcom/discretix/drm/api/IDxDrmCoreContent;->delete()V
...
.method public final deleteRights()V
    ...
    iget-object v1, p0, Lcom/discretix/drm/api/DxDrmFile;->mDrmContent:Lcom/discretix/drm/api/IDxDrmCoreContent;

    invoke-virtual {v1}, Lcom/discretix/drm/api/IDxDrmCoreContent;->DeleteRights()Lcom/discretix/drm/api/EDxDrmStatus;
...
.method protected finalize()V
    ...
    invoke-virtual {p0}, Lcom/discretix/drm/api/DxDrmFile;->close()V

    return-void
.end method

.method public final getActiveContent()J
    .locals 2

    iget-object v0, p0, Lcom/discretix/drm/api/DxDrmFile;->mDrmContent:Lcom/discretix/drm/api/IDxDrmCoreContent;

    invoke-virtual {v0}, Lcom/discretix/drm/api/IDxDrmCoreContent;->GetActiveContent()J
...
.method public final getActiveRO()Lcom/discretix/drm/api/DxRightsObject;
    ...
    invoke-virtual {v1}, Lcom/discretix/drm/api/IDxDrmCoreContent;->GetActiveRO()Lcom/discretix/drm/api/IDxRightsObject;
...
.method public getCurrentMaxProtectionLevel([J[J[J[J[J)V
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/discretix/drm/api/IDxDrmCoreContent;->GetCurrentMaxProtectionLevel([J[J[J[J[J)Lcom/discretix/drm/api/EDxDrmStatus;
...
.method public final getDRMScheme()Lcom/discretix/drm/api/EDxDrmScheme;
    ...
    invoke-virtual {v0}, Lcom/discretix/drm/api/IDxDrmCoreContent;->GetDRMScheme()Lcom/discretix/drm/api/EDxDrmScheme;
...
.method public final getFlags(J)J
    ...
    invoke-virtual/range {v0 .. v7}, Lcom/discretix/drm/api/IDxDrmCoreContent;->GetFlags(J[JJJ)Lcom/discretix/drm/api/EDxDrmStatus;
...
.method public final getLicenseInfo()[Lcom/discretix/drm/api/DxRightsObject;
    ...
    iget-object v5, p0, Lcom/discretix/drm/api/DxDrmFile;->mDrmContent:Lcom/discretix/drm/api/IDxDrmCoreContent;
    ...
    invoke-virtual {v5, v6, v1}, Lcom/discretix/drm/api/IDxDrmCoreContent;->PrepareForROIteration(Lcom/discretix/drm/api/EDxROIterationMode;[J)Lcom/discretix/drm/api/EDxDrmStatus;
    ...
    invoke-virtual {v5, v6, v7}, Lcom/discretix/drm/api/IDxDrmCoreContent;->GetRO(J)Lcom/discretix/drm/api/IDxRightsObject;
...
.method public final getNumOfContents()J
    .locals 2

    iget-object v0, p0, Lcom/discretix/drm/api/DxDrmFile;->mDrmContent:Lcom/discretix/drm/api/IDxDrmCoreContent;

    invoke-virtual {v0}, Lcom/discretix/drm/api/IDxDrmCoreContent;->GetNumOfContents()J
...
.method public final getTextAttribute(Lcom/discretix/drm/api/EDxTextAttribute;)Ljava/lang/String;
    ...
    invoke-virtual {v0, p1, v1, v2}, Lcom/discretix/drm/api/IDxDrmCoreContent;->GetTextAttribute(Lcom/discretix/drm/api/EDxTextAttribute;J)Ljava/lang/String;
...
.method public final getTextAttributeByName(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, p1, v1, v2}, Lcom/discretix/drm/api/IDxDrmCoreContent;->GetTextAttributeByName(Ljava/lang/String;J)Ljava/lang/String;
...
.method public final getTextAttributes()[Lcom/discretix/drm/api/DxTextAttribute;
    ...
    invoke-virtual {v0, v5, v6}, Lcom/discretix/drm/api/IDxDrmCoreContent;->GetNumOfTextAttributes(J)J
    ...
    invoke-virtual/range {v0 .. v6}, Lcom/discretix/drm/api/IDxDrmCoreContent;->GetTextAttributeByIndex(JLjava/lang/StringBuffer;Ljava/lang/StringBuffer;J)Lcom/discretix/drm/api/EDxDrmStatus;
...
.method public final handleConsumptionEvent(Lcom/discretix/drm/api/EDxConsumptionEvent;)V
    ...
    invoke-virtual {v1, p1}, Lcom/discretix/drm/api/IDxDrmCoreContent;->HandleConsumptionEvent(Lcom/discretix/drm/api/EDxConsumptionEvent;)Lcom/discretix/drm/api/EDxDrmStatus;
    ...
    iget-object v4, p0, Lcom/discretix/drm/api/DxDrmFile;->mDrmContent:Lcom/discretix/drm/api/IDxDrmCoreContent;

    invoke-virtual {v4}, Lcom/discretix/drm/api/IDxDrmCoreContent;->GetFileName()Ljava/lang/String;
...
.method public handleUserResponse(Lcom/discretix/drm/api/EDxUserResponse;)Lcom/discretix/drm/api/EDxDrmStatus;
    ...
    invoke-virtual {v0, p1}, Lcom/discretix/drm/api/IDxDrmCoreContent;->HandleUserResponse(Lcom/discretix/drm/api/EDxUserResponse;)Lcom/discretix/drm/api/EDxDrmStatus;
...
.method public installEmbeddedRights()V
    .locals 6
    ...
    new-array v0, v3, [Lcom/discretix/drm/api/IDxCoreImportStream;

    new-array v2, v3, [Z

    iget-object v3, p0, Lcom/discretix/drm/api/DxDrmFile;->mDrmContent:Lcom/discretix/drm/api/IDxDrmCoreContent;

    sget-object v4, Lcom/discretix/drm/api/EDxAutoMode;->DX_AUTO_ENABLED:Lcom/discretix/drm/api/EDxAutoMode;

    invoke-virtual {v3, v0, v4, v2}, Lcom/discretix/drm/api/IDxDrmCoreContent;->InstallEmbeddedRights([Lcom/discretix/drm/api/IDxCoreImportStream;Lcom/discretix/drm/api/EDxAutoMode;[Z)Lcom/discretix/drm/api/EDxDrmStatus;
    ...
    invoke-virtual {v3}, Lcom/discretix/drm/api/IDxCoreImportStream;->Finish()Lcom/discretix/drm/api/EDxDrmStatus;
...
.method public final isAttributeEditable(Lcom/discretix/drm/api/EDxTextAttribute;)Z
    ...
    invoke-virtual {v0, p1}, Lcom/discretix/drm/api/IDxDrmCoreContent;->IsAttributeEditable(Lcom/discretix/drm/api/EDxTextAttribute;)Z
...
.method public final isSoonToBeExpired(Lcom/discretix/drm/api/EDxIntent;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/discretix/drm/api/DxDrmFile;->SetIntent(Lcom/discretix/drm/api/EDxIntent;)Lcom/discretix/drm/api/EDxDrmStatus;
    ...
    invoke-virtual/range {v0 .. v7}, Lcom/discretix/drm/api/IDxDrmCoreContent;->IsSoonToBeExpired(JJ[Z[J[J)Lcom/discretix/drm/api/EDxDrmStatus;
...
.method public prepareForSuperDistribution()V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/discretix/drm/api/exceptions/DrmGeneralFailureException;
    ...
    invoke-virtual {v1}, Lcom/discretix/drm/api/IDxDrmCoreContent;->PrepareForSuperDistribution()Lcom/discretix/drm/api/EDxDrmStatus;
...
.method public final setActiveContent(J)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/discretix/drm/api/exceptions/DrmGeneralFailureException;
    ...
    invoke-virtual {v1, p1, p2}, Lcom/discretix/drm/api/IDxDrmCoreContent;->SetActiveContent(J)Lcom/discretix/drm/api/EDxDrmStatus;
...
.method public final setActiveContentById(Ljava/lang/String;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/discretix/drm/api/exceptions/DrmGeneralFailureException;
    ...
    invoke-virtual {v1, p1}, Lcom/discretix/drm/api/IDxDrmCoreContent;->SetActiveContentById(Ljava/lang/String;)Lcom/discretix/drm/api/EDxDrmStatus;
...
.method public final setIntent(Lcom/discretix/drm/api/EDxIntent;)V
    ...
    invoke-virtual {v1, p1}, Lcom/discretix/drm/api/IDxDrmCoreContent;->SetIntent(Lcom/discretix/drm/api/EDxIntent;)Lcom/discretix/drm/api/EDxDrmStatus;
...
.method public final setTextAttribute(Lcom/discretix/drm/api/EDxTextAttribute;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/discretix/drm/api/IDxDrmCoreContent;->SetTextAttribute(Lcom/discretix/drm/api/EDxTextAttribute;Ljava/lang/String;Ljava/lang/String;J)Lcom/discretix/drm/api/EDxDrmStatus;
...
.method public startRightsAcquisition([Lcom/discretix/drm/api/IDxCoreImportStream;Lcom/discretix/drm/api/EDxRightsAcquisitionMethod;)Lcom/discretix/drm/api/EDxDrmStatus;
    ...
    invoke-virtual {v0, p1, p2}, Lcom/discretix/drm/api/IDxDrmCoreContent;->StartRightsAcquisition([Lcom/discretix/drm/api/IDxCoreImportStream;Lcom/discretix/drm/api/EDxRightsAcquisitionMethod;)Lcom/discretix/drm/api/EDxDrmStatus;
...
.method public startSetIntent([Lcom/discretix/drm/api/IDxCoreImportStream;Lcom/discretix/drm/api/EDxIntent;Lcom/discretix/drm/api/EDxAutoMode;)Lcom/discretix/drm/api/EDxDrmStatus;
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcom/discretix/drm/api/IDxDrmCoreContent;->StartSetIntent([Lcom/discretix/drm/api/IDxCoreImportStream;Lcom/discretix/drm/api/EDxIntent;Lcom/discretix/drm/api/EDxAutoMode;)Lcom/discretix/drm/api/EDxDrmStatus;
...
.method public final verifyRights(Landroid/app/Activity;Lcom/discretix/drm/api/EDxAutoMode;Lcom/discretix/drm/api/EDxIntent;Z)Lcom/discretix/drm/api/EDxVerifyStatus;
    ...
    invoke-direct {p0, p2, p3}, Lcom/discretix/drm/api/DxDrmFile;->verifyRightsInner(Lcom/discretix/drm/api/EDxAutoMode;Lcom/discretix/drm/api/EDxIntent;)Lcom/discretix/drm/api/EDxVerifyStatus;
    ...
    invoke-virtual {v3}, Lcom/discretix/drm/api/IDxDrmCoreContent;->GetFileName()Ljava/lang/String;
    ...
    invoke-virtual {p0, v3}, Lcom/discretix/drm/api/DxDrmFile;->getTextAttribute(Lcom/discretix/drm/api/EDxTextAttribute;)Ljava/lang/String;
...
.method public final verifyRights(Landroid/content/Context;Lcom/discretix/drm/api/EDxAutoMode;Lcom/discretix/drm/api/EDxIntent;ZZLjava/lang/String;)Lcom/discretix/drm/api/EDxVerifyStatus;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/discretix/drm/api/exceptions/DrmGeneralFailureException;
    ...
    const-string v2, "DX_LA_URL_EXTRA"
...
.method public verifyRightsFromFD(Landroid/content/Context;Lcom/discretix/drm/api/EDxAutoMode;Lcom/discretix/drm/api/EDxIntent;Landroid/net/Uri;Z)Lcom/discretix/drm/api/EDxVerifyStatus;
    ...
    iput-boolean v4, p0, Lcom/discretix/drm/api/DxDrmFile;->mDontDeleteDrmContent:Z
