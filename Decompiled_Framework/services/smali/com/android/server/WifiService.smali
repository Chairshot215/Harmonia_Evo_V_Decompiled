...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v7, p0, Lcom/android/server/WifiService;->mEmergencyModeChanged:Z

    const/4 v7, 0x0

    iput-boolean v7, p0, Lcom/android/server/WifiService;->mPreEmergencyModeChanged:Z

    new-instance v7, Lcom/android/server/WifiService$LockList;

    const/4 v8, 0x0

    invoke-direct {v7, p0, v8}, Lcom/android/server/WifiService$LockList;-><init>(Lcom/android/server/WifiService;Lcom/android/server/WifiService$1;)V

    iput-object v7, p0, Lcom/android/server/WifiService;->mLocks:Lcom/android/server/WifiService$LockList;

    const/4 v7, 0x0

    iput-boolean v7, p0, Lcom/android/server/WifiService;->mHTCWirelessSleepModeEnabled:Z

    const/4 v7, 0x0

    iput-boolean v7, p0, Lcom/android/server/WifiService;->mHTCWirelessInSleepTime:Z

    const/4 v7, 0x0

    iput-boolean v7, p0, Lcom/android/server/WifiService;->mQuickBootPowerOffIntentReceived:Z
    ...
    iput-object v7, p0, Lcom/android/server/WifiService;->mWifiApAirplaneModeOverwridden:Ljava/util/concurrent/atomic/AtomicBoolean;

    const/4 v7, 0x0

    iput-boolean v7, p0, Lcom/android/server/WifiService;->mForbiddenByExchangePolicy:Z

    const/4 v7, 0x0

    iput-boolean v7, p0, Lcom/android/server/WifiService;->mAutoEnableWifiApInDockMode:Z

    const/4 v7, 0x1

    iput-boolean v7, p0, Lcom/android/server/WifiService;->mAutoEnableWifiInDockMode:Z

    const/4 v7, 0x0

    iput-boolean v7, p0, Lcom/android/server/WifiService;->mInDockMode:Z

    const/4 v7, 0x0

    iput-boolean v7, p0, Lcom/android/server/WifiService;->mIfWiFiRegBastReceiver:Z

    new-instance v7, Landroid/net/wifi/WifiConfiguration;

    invoke-direct {v7}, Landroid/net/wifi/WifiConfiguration;-><init>()V

    iput-object v7, p0, Lcom/android/server/WifiService;->mConfig:Landroid/net/wifi/WifiConfiguration;
    ...
    iput-wide v7, p0, Lcom/android/server/WifiService;->mCwExpiredTime:J

    invoke-static {}, Landroid/bluetooth/BluetoothAdapter;->getDefaultAdapter()Landroid/bluetooth/BluetoothAdapter;

    move-result-object v7

    iput-object v7, p0, Lcom/android/server/WifiService;->mBluetoothAdapter:Landroid/bluetooth/BluetoothAdapter;

    const/4 v7, 0x0

    iput-boolean v7, p0, Lcom/android/server/WifiService;->mCWRegisteredWhenScreenOff:Z
    ...
    iput-boolean v7, p0, Lcom/android/server/WifiService;->mEnableMHS:Z

    const/4 v7, 0x0

    iput-boolean v7, p0, Lcom/android/server/WifiService;->mEnableMhsFeature:Z

    const/4 v7, 0x0

    iput-boolean v7, p0, Lcom/android/server/WifiService;->mPersistMHS:Z

    const/4 v7, 0x0

    iput-object v7, p0, Lcom/android/server/WifiService;->mWifiConfigMHS:Landroid/net/wifi/WifiConfiguration;

    const/4 v7, 0x0

    iput-boolean v7, p0, Lcom/android/server/WifiService;->mProcessingMHS:Z
    ...
    iput v7, p0, Lcom/android/server/WifiService;->mMhsStatus:I
    ...
    iput-boolean v7, p0, Lcom/android/server/WifiService;->mEnableImeiPassword:Z

    const/4 v7, 0x0

    iput-boolean v7, p0, Lcom/android/server/WifiService;->mEnableImeiSsid:Z

    const/4 v7, 0x0

    iput-boolean v7, p0, Lcom/android/server/WifiService;->mEnableMdnPassword:Z

    const/4 v7, 0x0

    iput-boolean v7, p0, Lcom/android/server/WifiService;->mWifiEnabledByDock:Z

    const/4 v7, 0x0

    iput v7, p0, Lcom/android/server/WifiService;->msenseVersion:F
    ...
    iput-object v7, p0, Lcom/android/server/WifiService;->mMhsReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-virtual {v7, v8}, Landroid/net/wifi/WifiStateMachine;->enableRssiPolling(Z)V
    ...
    const-string v7, "com.android.server.WifiManager.action.CW_EXPIRED_REREGISTER"
    ...
    iput-object v7, p0, Lcom/android/server/WifiService;->mCWExpiredReregisterIntent:Landroid/app/PendingIntent;
    ...
    iput-object v7, p0, Lcom/android/server/WifiService;->mWifiApSleepIntent:Landroid/app/PendingIntent;
    ...
    iput-object v7, p0, Lcom/android/server/WifiService;->mWifiApConnReqTimeout:Landroid/app/PendingIntent;
    ...
    const-string v7, "android.net.conn.HTC_PERMITTED_TETHER_CHANGE"

    invoke-virtual {v3, v7}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    iget-object v7, p0, Lcom/android/server/WifiService;->mContext:Landroid/content/Context;

    iget-object v8, p0, Lcom/android/server/WifiService;->mMhsReceiver:Landroid/content/BroadcastReceiver;
    ...
    new-instance v7, Lcom/android/server/WifiService$WifiHandler;

    invoke-virtual {v6}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v8

    invoke-direct {v7, p0, v8}, Lcom/android/server/WifiService$WifiHandler;-><init>(Lcom/android/server/WifiService;Landroid/os/Looper;)V

    iput-object v7, p0, Lcom/android/server/WifiService;->mWifiHandler:Lcom/android/server/WifiService$WifiHandler;
    ...
    const-string v8, "[C+W] Add ACTION_CW_REGISTRATION_STATE_CHANGED receiver"
    ...
    const-string v10, "android.intent.action.ACTION_CW_REGISTRATION_STATE_CHANGED"
    ...
    const-string v8, "[C+W] Add ACTION_MOBILEDATA_MODE_CHANGED receiver"
    ...
    const-string v10, "android.intent.action.MOBILEDATA_MODE"
    ...
    :cond_5
    iget-boolean v7, p0, Lcom/android/server/WifiService;->mEnableMdnPassword:Z
    ...
    const-string v10, "android.intent.action.QUICKBOOT_POWEROFF"
    ...
    new-instance v8, Lcom/android/server/WifiService$8;

    invoke-direct {v8, p0}, Lcom/android/server/WifiService$8;-><init>(Lcom/android/server/WifiService;)V

    new-instance v9, Landroid/content/IntentFilter;

    const-string v10, "com.android.kineto.GanState"
    ...
    new-instance v8, Lcom/android/server/WifiService$9;

    invoke-direct {v8, p0}, Lcom/android/server/WifiService$9;-><init>(Lcom/android/server/WifiService;)V

    new-instance v9, Landroid/content/IntentFilter;

    const-string v10, "android.app.admin.intent.ALLOW_WIFI_CHANGE"
    ...
    new-instance v8, Lcom/android/server/WifiService$10;

    invoke-direct {v8, p0}, Lcom/android/server/WifiService$10;-><init>(Lcom/android/server/WifiService;)V
    ...
    new-instance v8, Lcom/android/server/WifiService$11;

    invoke-direct {v8, p0}, Lcom/android/server/WifiService$11;-><init>(Lcom/android/server/WifiService;)V
    ...
    iget v7, p0, Lcom/android/server/WifiService;->msenseVersion:F
    ...
    const-string v8, "DockWifi - Add ACTION_DOCK_EVENT (wifi) receiver"
    ...
    :goto_3
    sget-boolean v7, Lcom/htc/htcjavaflag/HtcBuildFlag;->HTC_EAP_AKA_flag:Z

    if-eqz v7, :cond_a

    const-string v7, "WifiService"

    const-string v8, "AKA: HTC_EAP_AKA_flag is true"

    invoke-static {v7, v8}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v7, p0, Lcom/android/server/WifiService;->mContext:Landroid/content/Context;

    new-instance v8, Lcom/android/server/WifiService$15;

    invoke-direct {v8, p0}, Lcom/android/server/WifiService$15;-><init>(Lcom/android/server/WifiService;)V
    ...
    iput-boolean v7, p0, Lcom/android/server/WifiService;->mBackgroundScanSupported:Z
    ...
    :cond_c
    iget-boolean v7, p0, Lcom/android/server/WifiService;->mEnableImeiPassword:Z

    iget-boolean v8, p0, Lcom/android/server/WifiService;->mEnableImeiSsid:Z
    ...
    invoke-direct {v8, p0}, Lcom/android/server/WifiService$12;-><init>(Lcom/android/server/WifiService;)V
    ...
    const-string v8, "DockWifi - Add ACTION_DOCK_EVENT (hotspot) receiver"

    invoke-static {v7, v8}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v7, p0, Lcom/android/server/WifiService;->mContext:Landroid/content/Context;

    new-instance v8, Lcom/android/server/WifiService$14;

    invoke-direct {v8, p0}, Lcom/android/server/WifiService$14;-><init>(Lcom/android/server/WifiService;)V
    ...
    const-string v8, "DockWifi - NOT add ACTION_DOCK_EVENT receiver"
...
.method static synthetic access$2700(Lcom/android/server/WifiService;)Lcom/android/server/WifiService$WifiHandler;
    .locals 1
...
.method static synthetic access$3100(Lcom/android/server/WifiService;Landroid/content/Context;)V
    .locals 0
...
.method static synthetic access$4100(Lcom/android/server/WifiService;)Landroid/app/PendingIntent;
    .locals 1
...
.method static synthetic access$4200(Lcom/android/server/WifiService;)Landroid/app/AlarmManager;
    .locals 1
...
.method static synthetic access$5700(Lcom/android/server/WifiService;)Lcom/android/server/WifiService$LockList;
    .locals 1
...
.method static synthetic access$5800(Lcom/android/server/WifiService;Landroid/os/IBinder;)Z
    .locals 1
...
.method static synthetic access$6600(Lcom/android/server/WifiService;)Ljava/util/List;
    .locals 1
...
.method static synthetic access$6700(Lcom/android/server/WifiService;II)V
    .locals 0
...
.method static synthetic access$6802(Lcom/android/server/WifiService;Z)Z
    .locals 0
...
.method private acquireWifiLockLocked(Lcom/android/server/WifiService$WifiLock;)Z
    ...
    invoke-static {v3, p1}, Lcom/android/server/WifiService$LockList;->access$6300(Lcom/android/server/WifiService$LockList;Lcom/android/server/WifiService$WifiLock;)V
...
.method private releaseWifiLockLocked(Landroid/os/IBinder;)Z
    ...
    invoke-static {v4, p1}, Lcom/android/server/WifiService$LockList;->access$6500(Lcom/android/server/WifiService$LockList;Landroid/os/IBinder;)Lcom/android/server/WifiService$WifiLock;
...
.method private declared-synchronized reportStartWorkSource()V
    ...
    invoke-static {v1}, Lcom/android/server/WifiService$LockList;->access$5300(Lcom/android/server/WifiService$LockList;)Ljava/util/List;
...
.method private updateWifiState()V
    ...
    invoke-static {v8}, Lcom/android/server/WifiService$LockList;->access$5400(Lcom/android/server/WifiService$LockList;)Z
    ...
    invoke-static {v8}, Lcom/android/server/WifiService$LockList;->access$5500(Lcom/android/server/WifiService$LockList;)I
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-static {v3, p2}, Lcom/android/server/WifiService$LockList;->access$5600(Lcom/android/server/WifiService$LockList;Ljava/io/PrintWriter;)V
...
.method public updateWifiLockWorkSource(Landroid/os/IBinder;Landroid/os/WorkSource;)V
    ...
    invoke-static {v6, p1}, Lcom/android/server/WifiService$LockList;->access$6400(Lcom/android/server/WifiService$LockList;Landroid/os/IBinder;)I
    ...
    #getter for: Lcom/android/server/WifiService$LockList;->mList:Ljava/util/List;
    invoke-static {v6}, Lcom/android/server/WifiService$LockList;->access$5300(Lcom/android/server/WifiService$LockList;)Ljava/util/List;
