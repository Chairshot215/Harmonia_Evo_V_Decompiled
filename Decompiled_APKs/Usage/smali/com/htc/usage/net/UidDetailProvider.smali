.class public Lcom/htc/usage/net/UidDetailProvider;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/htc/usage/net/UidDetailProvider;->mContext:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/htc/usage/net/UidDetailProvider;->mUidDetailCache:Landroid/util/SparseArray;
...
.method public clearCache()V
    ...
    .prologue
    .line 43
    iget-object v0, p0, Lcom/htc/usage/net/UidDetailProvider;->mUidDetailCache:Landroid/util/SparseArray;
...
.method public getUidDetail(IZ)Lcom/htc/usage/net/UidDetail;
    .locals 14
    .parameter "uid"
    .parameter "blocking"
    ...
    .prologue
    .line 50
    iget-object v12, p0, Lcom/htc/usage/net/UidDetailProvider;->mUidDetailCache:Landroid/util/SparseArray;

    invoke-virtual {v12, p1}, Landroid/util/SparseArray;->get(I)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lcom/htc/usage/net/UidDetail;

    .line 51
    .local v1, cached:Lcom/htc/usage/net/UidDetail;
    if-eqz v1, :cond_0
    ...
    .line 57
    :cond_1
    iget-object v12, p0, Lcom/htc/usage/net/UidDetailProvider;->mContext:Landroid/content/Context;
    ...
    new-instance v3, Lcom/htc/usage/net/UidDetail;

    invoke-direct {v3}, Lcom/htc/usage/net/UidDetail;-><init>()V

    .line 61
    .local v3, detail:Lcom/htc/usage/net/UidDetail;
    invoke-virtual {v10, p1}, Landroid/content/pm/PackageManager;->getNameForUid(I)Ljava/lang/String;

    move-result-object v12

    iput-object v12, v3, Lcom/htc/usage/net/UidDetail;->label:Ljava/lang/CharSequence;
    ...
    iput-object v12, v3, Lcom/htc/usage/net/UidDetail;->icon:Landroid/graphics/drawable/Drawable;
    ...
    :cond_2
    :goto_2
    iget-object v12, v3, Lcom/htc/usage/net/UidDetail;->label:Ljava/lang/CharSequence;
    ...
    invoke-static {v2}, Lcom/htc/usage/Utils;->getTetheringLabel(Landroid/net/ConnectivityManager;)I
    ...
    iput-object v12, v3, Lcom/htc/usage/net/UidDetail;->detailLabels:[Ljava/lang/CharSequence;
    ...
    iget-object v12, v3, Lcom/htc/usage/net/UidDetail;->detailLabels:[Ljava/lang/CharSequence;
