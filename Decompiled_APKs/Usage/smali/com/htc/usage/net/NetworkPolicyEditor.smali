.class public Lcom/htc/usage/net/NetworkPolicyEditor;
...
.field public static final TAG:Ljava/lang/String; = "NetworkPolicyEditor"
...
.method public constructor <init>(Landroid/net/INetworkPolicyManager;)V
    ...
    iput-object v0, p0, Lcom/htc/usage/net/NetworkPolicyEditor;->mPolicies:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lcom/htc/usage/net/NetworkPolicyEditor;->mPolicyService:Landroid/net/INetworkPolicyManager;
...
.method private forceMobilePolicyCombined()Z
    ...
    iget-object v5, p0, Lcom/htc/usage/net/NetworkPolicyEditor;->mPolicies:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v3, v5}, Lcom/htc/usage/net/NetworkPolicyEditor;->setMobilePolicySplitInternal(Ljava/lang/String;Z)Z
...
.method private setMobilePolicySplitInternal(Ljava/lang/String;Z)Z
    ...
    .prologue
    .line 238
    invoke-virtual/range {p0 .. p1}, Lcom/htc/usage/net/NetworkPolicyEditor;->isMobilePolicySplit(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, v5}, Lcom/htc/usage/net/NetworkPolicyEditor;->getPolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
    ...
    invoke-virtual {v0, v1}, Lcom/htc/usage/net/NetworkPolicyEditor;->getPolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
    ...
    iget-object v2, v0, Lcom/htc/usage/net/NetworkPolicyEditor;->mPolicies:Ljava/util/ArrayList;
    ...
    iget-object v11, v0, Lcom/htc/usage/net/NetworkPolicyEditor;->mPolicies:Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v3}, Lcom/htc/usage/net/NetworkPolicyEditor;->getPolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
...
.method public getOrCreatePolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
    ...
    .prologue
    .line 124
    invoke-virtual {p0, p1}, Lcom/htc/usage/net/NetworkPolicyEditor;->getPolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
    ...
    .line 126
    invoke-static {p1}, Lcom/htc/usage/net/NetworkPolicyEditor;->buildDefaultPolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;

    move-result-object v0

    .line 127
    iget-object v1, p0, Lcom/htc/usage/net/NetworkPolicyEditor;->mPolicies:Ljava/util/ArrayList;
...
.method public getPolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
    ...
    .prologue
    .line 133
    iget-object v2, p0, Lcom/htc/usage/net/NetworkPolicyEditor;->mPolicies:Ljava/util/ArrayList;
...
.method public getPolicyCycleDay(Landroid/net/NetworkTemplate;)I
    ...
    .line 153
    .local v0, networkPolicy:Landroid/net/NetworkPolicy;
    if-eqz v0, :cond_0
    ...
    iget v1, v1, Landroid/net/NetworkPolicy;->cycleDay:I
    ...
    const-string v2, "No network policy exists."
...
.method public read()V
    ...
    .line 62
    :try_start_0
    iget-object v7, p0, Lcom/htc/usage/net/NetworkPolicyEditor;->mPolicyService:Landroid/net/INetworkPolicyManager;
    ...
    .line 68
    .local v4, modified:Z
    iget-object v7, p0, Lcom/htc/usage/net/NetworkPolicyEditor;->mPolicies:Ljava/util/ArrayList;
    ...
    .end local v6           #policy:Landroid/net/NetworkPolicy;
    :cond_3
    invoke-direct {p0}, Lcom/htc/usage/net/NetworkPolicyEditor;->forceMobilePolicyCombined()Z
    ...
    invoke-virtual {p0}, Lcom/htc/usage/net/NetworkPolicyEditor;->writeAsync()V
...
.method public setMobilePolicySplit(Ljava/lang/String;Z)V
    ...
    .prologue
    .line 226
    invoke-direct {p0, p1, p2}, Lcom/htc/usage/net/NetworkPolicyEditor;->setMobilePolicySplitInternal(Ljava/lang/String;Z)Z
...
.method public setPolicyCycleDay(Landroid/net/NetworkTemplate;I)V
    ...
    .prologue
    .line 162
    invoke-virtual {p0, p1}, Lcom/htc/usage/net/NetworkPolicyEditor;->getOrCreatePolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
...
.method public write([Landroid/net/NetworkPolicy;)V
    ...
    .line 112
    :try_start_0
    iget-object v1, p0, Lcom/htc/usage/net/NetworkPolicyEditor;->mPolicyService:Landroid/net/INetworkPolicyManager;
...
.method public writeAsync()V
    ...
    new-instance v1, Lcom/htc/usage/net/NetworkPolicyEditor$1;

    invoke-direct {v1, p0, v0}, Lcom/htc/usage/net/NetworkPolicyEditor$1;-><init>(Lcom/htc/usage/net/NetworkPolicyEditor;[Landroid/net/NetworkPolicy;)V

    const/4 v2, 0x0

    new-array v2, v2, [Ljava/lang/Void;

    invoke-virtual {v1, v2}, Lcom/htc/usage/net/NetworkPolicyEditor$1;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
