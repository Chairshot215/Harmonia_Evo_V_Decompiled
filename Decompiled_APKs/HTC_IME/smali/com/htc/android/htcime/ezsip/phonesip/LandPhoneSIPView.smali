.class public Lcom/htc/android/htcime/ezsip/phonesip/LandPhoneSIPView;
.super Lcom/htc/android/htcime/ezsip/KeyboardView;
.source "LandPhoneSIPView.java"
...
# static fields
.field private static final TAG:Ljava/lang/String; = "LandPhoneSIPView"
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Lcom/htc/android/htcime/ezsip/phonesip/LandPhoneSIPView;->mMyData:Lcom/htc/android/htcime/Intf/HTCSIPData;

    .line 48
    iget-object v0, p0, Lcom/htc/android/htcime/ezsip/phonesip/LandPhoneSIPView;->mMyData:Lcom/htc/android/htcime/Intf/HTCSIPData;

    const-string v1, "Landscape Phone"
...
.method public finishInput()V
    ...
    .prologue
    .line 106
    invoke-virtual {p0}, Lcom/htc/android/htcime/ezsip/phonesip/LandPhoneSIPView;->closing()V
...
.method public init(Lcom/htc/android/htcime/HTCIMEService;)V
    ...
    .line 62
    iput-object p1, p0, Lcom/htc/android/htcime/ezsip/phonesip/LandPhoneSIPView;->mHTCIMM:Lcom/htc/android/htcime/HTCIMEService;

    .line 63
    iget-object v0, p0, Lcom/htc/android/htcime/ezsip/phonesip/LandPhoneSIPView;->mHTCIMM:Lcom/htc/android/htcime/HTCIMEService;

    invoke-virtual {v0}, Lcom/htc/android/htcime/HTCIMEService;->getShareData()Lcom/htc/android/htcime/HTCIMMData;

    move-result-object v0

    iput-object v0, p0, Lcom/htc/android/htcime/ezsip/phonesip/LandPhoneSIPView;->mHTCIMMData:Lcom/htc/android/htcime/HTCIMMData;
    ...
    invoke-virtual {p0, v0}, Lcom/htc/android/htcime/ezsip/phonesip/LandPhoneSIPView;->setKeyboard(Lcom/htc/android/htcime/ezsip/Keyboard;)V

    .line 65
    iget-object v0, p0, Lcom/htc/android/htcime/ezsip/phonesip/LandPhoneSIPView;->mMyData:Lcom/htc/android/htcime/Intf/HTCSIPData;

    iget-object v1, p0, Lcom/htc/android/htcime/ezsip/phonesip/LandPhoneSIPView;->mKeyboard:Lcom/htc/android/htcime/ezsip/Keyboard;
    ...
    invoke-virtual {p0, v3, v0}, Lcom/htc/android/htcime/ezsip/phonesip/LandPhoneSIPView;->setPopupOffset(II)V

    .line 68
    iput v3, p0, Lcom/htc/android/htcime/ezsip/phonesip/LandPhoneSIPView;->mSIP_ID:I

    .line 69
    const/high16 v0, 0xf00

    iput v0, p0, Lcom/htc/android/htcime/ezsip/phonesip/LandPhoneSIPView;->mSIP_LP_ID:I
...
.method public onClick(III)V
    ...
    .line 140
    iget-object v1, p0, Lcom/htc/android/htcime/ezsip/phonesip/LandPhoneSIPView;->mKeys:[Lcom/htc/android/htcime/ezsip/Keyboard$Key;
    ...
    .line 180
    iget-object v1, p0, Lcom/htc/android/htcime/ezsip/phonesip/LandPhoneSIPView;->mHTCIMM:Lcom/htc/android/htcime/HTCIMEService;
    ...
    invoke-virtual {p0, v1}, Lcom/htc/android/htcime/ezsip/phonesip/LandPhoneSIPView;->sendKeyEvent(I)V
    ...
    iget-object v2, p0, Lcom/htc/android/htcime/ezsip/phonesip/LandPhoneSIPView;->mHTCIMMData:Lcom/htc/android/htcime/HTCIMMData;

    iget v2, v2, Lcom/htc/android/htcime/HTCIMMData;->mLandPrimarySIP:I
...
.method public startInput()V
    ...
    .line 81
    invoke-virtual {p0}, Lcom/htc/android/htcime/ezsip/phonesip/LandPhoneSIPView;->init_lpd_data()V

    .line 83
    sget-boolean v1, Lcom/htc/android/htcime/HTCIMMData;->InternalTest_ShowHint:Z

    invoke-virtual {p0, v1}, Lcom/htc/android/htcime/ezsip/phonesip/LandPhoneSIPView;->setPreviewEnabled(Z)V

    .line 84
    invoke-virtual {p0}, Lcom/htc/android/htcime/ezsip/phonesip/LandPhoneSIPView;->previewDismiss()V
    ...
    :goto_0
    invoke-virtual {p0}, Lcom/htc/android/htcime/ezsip/phonesip/LandPhoneSIPView;->setStatusIcon()V
    ...
    iget-object v3, p0, Lcom/htc/android/htcime/ezsip/phonesip/LandPhoneSIPView;->mHTCIMMData:Lcom/htc/android/htcime/HTCIMMData;
    ...
    .line 96
    invoke-virtual {p0}, Lcom/htc/android/htcime/ezsip/phonesip/LandPhoneSIPView;->invalidateAll()V
