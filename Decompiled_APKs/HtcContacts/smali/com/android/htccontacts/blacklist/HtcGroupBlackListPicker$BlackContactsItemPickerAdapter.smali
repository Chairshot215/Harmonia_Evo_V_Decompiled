.class public Lcom/android/htccontacts/blacklist/HtcGroupBlackListPicker$BlackContactsItemPickerAdapter;
...
.annotation system Ldalvik/annotation/InnerClass;
    accessFlags = 0x4
    name = "BlackContactsItemPickerAdapter"
.end annotation
...
# direct methods
.method public constructor <init>(Lcom/android/htccontacts/blacklist/HtcGroupBlackListPicker;Landroid/content/Context;ILandroid/database/Cursor;)V
    .locals 0
    .parameter
    .parameter "context"
    .parameter "resource"
    ...
    .prologue
    .line 552
    iput-object p1, p0, Lcom/android/htccontacts/blacklist/HtcGroupBlackListPicker$BlackContactsItemPickerAdapter;->this$0:Lcom/android/htccontacts/blacklist/HtcGroupBlackListPicker;
...
.method protected bindName(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;Lcom/android/htccontacts/app/ContactsListActivity$ContactListItemCache;Ljava/lang/String;)V
    ...
    .line 640
    iget-object v3, p0, Lcom/android/htccontacts/blacklist/HtcGroupBlackListPicker$BlackContactsItemPickerAdapter;->this$0:Lcom/android/htccontacts/blacklist/HtcGroupBlackListPicker;

    #getter for: Lcom/android/htccontacts/blacklist/HtcGroupBlackListPicker;->mFilterString:Ljava/lang/String;
    invoke-static {v3}, Lcom/android/htccontacts/blacklist/HtcGroupBlackListPicker;->access$500(Lcom/android/htccontacts/blacklist/HtcGroupBlackListPicker;)Ljava/lang/String;
    ...
    iget-object v4, p0, Lcom/android/htccontacts/blacklist/HtcGroupBlackListPicker$BlackContactsItemPickerAdapter;->this$0:Lcom/android/htccontacts/blacklist/HtcGroupBlackListPicker;

    #getter for: Lcom/android/htccontacts/ContactListSearchPicker;->BACKGROUND_SPAN:Landroid/text/style/BackgroundColorSpan;
    invoke-static {v4}, Lcom/android/htccontacts/blacklist/HtcGroupBlackListPicker;->access$600(Lcom/android/htccontacts/blacklist/HtcGroupBlackListPicker;)Landroid/text/style/BackgroundColorSpan;

    move-result-object v4

    iget-object v5, p0, Lcom/android/htccontacts/blacklist/HtcGroupBlackListPicker$BlackContactsItemPickerAdapter;->this$0:Lcom/android/htccontacts/blacklist/HtcGroupBlackListPicker;

    #getter for: Lcom/android/htccontacts/ContactListSearchPicker;->FOREGROUND_SPAN:Landroid/text/style/ForegroundColorSpan;
    invoke-static {v5}, Lcom/android/htccontacts/blacklist/HtcGroupBlackListPicker;->access$700(Lcom/android/htccontacts/blacklist/HtcGroupBlackListPicker;)Landroid/text/style/ForegroundColorSpan;
...
.method protected bindSource(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;Lcom/android/htccontacts/app/ContactsListActivity$ContactListItemCache;Ljava/lang/String;)V
    ...
    .prologue
    .line 601
    invoke-super/range {p0 .. p5}, Lcom/android/htccontacts/ContactListSearchPicker$ContactsItemPickerAdapter;->bindSource(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;Lcom/android/htccontacts/app/ContactsListActivity$ContactListItemCache;Ljava/lang/String;)V
...
.method public bindView(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;)V
    ...
    .line 570
    invoke-super {p0, p1, p2, p3}, Lcom/android/htccontacts/ContactListSearchPicker$ContactsItemPickerAdapter;->bindView(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;)V
    ...
    .line 584
    .local v4, isCheck:Z
    invoke-virtual {p0}, Lcom/android/htccontacts/blacklist/HtcGroupBlackListPicker$BlackContactsItemPickerAdapter;->getAccountTypeIndex()I
    ...
    iget-object v8, p0, Lcom/android/htccontacts/blacklist/HtcGroupBlackListPicker$BlackContactsItemPickerAdapter;->this$0:Lcom/android/htccontacts/blacklist/HtcGroupBlackListPicker;

    #getter for: Lcom/android/htccontacts/blacklist/HtcGroupBlackListPicker;->isPickBlockNumberForDelete:Z
    invoke-static {v8}, Lcom/android/htccontacts/blacklist/HtcGroupBlackListPicker;->access$200(Lcom/android/htccontacts/blacklist/HtcGroupBlackListPicker;)Z
    ...
    #getter for: Lcom/android/htccontacts/blacklist/HtcGroupBlackListPicker;->mCacheBooleanArrayForblock:Landroid/util/SparseBooleanArray;
    invoke-static {v8}, Lcom/android/htccontacts/blacklist/HtcGroupBlackListPicker;->access$300(Lcom/android/htccontacts/blacklist/HtcGroupBlackListPicker;)Landroid/util/SparseBooleanArray;
    ...
    invoke-static {v8}, Lcom/android/htccontacts/blacklist/HtcGroupBlackListPicker;->access$400(Lcom/android/htccontacts/blacklist/HtcGroupBlackListPicker;)Landroid/util/LongSparseArray;
...
.method public newView(Landroid/content/Context;Landroid/database/Cursor;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .prologue
    .line 558
    invoke-super {p0, p1, p2, p3}, Lcom/android/htccontacts/ContactListSearchPicker$ContactsItemPickerAdapter;->newView(Landroid/content/Context;Landroid/database/Cursor;Landroid/view/ViewGroup;)Landroid/view/View;
...
.method public runQueryOnBackgroundThread(Ljava/lang/CharSequence;)Landroid/database/Cursor;
    ...
    .prologue
    .line 627
    invoke-super {p0, p1}, Lcom/android/htccontacts/ContactListSearchPicker$ContactsItemPickerAdapter;->runQueryOnBackgroundThread(Ljava/lang/CharSequence;)Landroid/database/Cursor;
...
.method protected updateIndex(Landroid/database/Cursor;)V
    ...
    .line 622
    :cond_0
    invoke-super {p0, p1}, Lcom/android/htccontacts/ContactListSearchPicker$ContactsItemPickerAdapter;->updateIndex(Landroid/database/Cursor;)V
