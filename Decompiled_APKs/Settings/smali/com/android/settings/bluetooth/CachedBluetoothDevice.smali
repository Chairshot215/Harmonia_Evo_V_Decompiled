...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/settings/bluetooth/CachedBluetoothDevice$ConnectThread;
    }
.end annotation
...
.field public static final PRESET_PIN_NAME:[Ljava/lang/String; = null
...
.field private mConnectThread:Lcom/android/settings/bluetooth/CachedBluetoothDevice$ConnectThread;

.field private final mContext:Landroid/content/Context;

.field private mDelayMapping:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap",
            "<",
...
.method static constructor <clinit>()V
    ...
    const-string v2, "i.Tech BlueBAND"

    aput-object v2, v0, v1

    const/4 v1, 0x2

    const-string v2, "Parrot Minikit Slim v1.0"

    aput-object v2, v0, v1

    sput-object v0, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->PRESET_PIN_NAME:[Ljava/lang/String;
...
.method constructor <init>(Landroid/content/Context;Lcom/android/settings/bluetooth/LocalBluetoothAdapter;Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;Landroid/bluetooth/BluetoothDevice;)V
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mDelayMapping:Ljava/util/HashMap;
...
.method static synthetic access$000(Lcom/android/settings/bluetooth/CachedBluetoothDevice;)Z
    ...
    .prologue
    .line 44
    invoke-direct {p0}, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->isCarkit()Z
...
.method static synthetic access$100(Lcom/android/settings/bluetooth/CachedBluetoothDevice;)Landroid/bluetooth/BluetoothDevice;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$200(Lcom/android/settings/bluetooth/CachedBluetoothDevice;)Ljava/util/HashMap;
    .locals 1
    .parameter "x0"

    .prologue
    .line 44
    iget-object v0, p0, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mDelayMapping:Ljava/util/HashMap;

    return-object v0
.end method

.method static synthetic access$300(Lcom/android/settings/bluetooth/CachedBluetoothDevice;)Lcom/android/settings/bluetooth/LocalBluetoothAdapter;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$400(Lcom/android/settings/bluetooth/CachedBluetoothDevice;Lcom/android/settings/bluetooth/LocalBluetoothProfile;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$502(Lcom/android/settings/bluetooth/CachedBluetoothDevice;Lcom/android/settings/bluetooth/CachedBluetoothDevice$ConnectThread;)Lcom/android/settings/bluetooth/CachedBluetoothDevice$ConnectThread;
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 44
    iput-object p1, p0, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mConnectThread:Lcom/android/settings/bluetooth/CachedBluetoothDevice$ConnectThread;
...
.method private connectAutoConnectableProfiles()V
    ...
    iget-object v3, p0, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mConnectThread:Lcom/android/settings/bluetooth/CachedBluetoothDevice$ConnectThread;
    ...
    .line 301
    .local v1, preferedList:Ljava/util/List;,"Ljava/util/List<Lcom/android/settings/bluetooth/LocalBluetoothProfile;>;"
    ...
    :cond_3
    new-instance v3, Lcom/android/settings/bluetooth/CachedBluetoothDevice$ConnectThread;

    iget-boolean v4, p0, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mConnectAfterPairing:Z

    invoke-direct {v3, p0, v1, p0, v4}, Lcom/android/settings/bluetooth/CachedBluetoothDevice$ConnectThread;-><init>(Lcom/android/settings/bluetooth/CachedBluetoothDevice;Ljava/util/List;Lcom/android/settings/bluetooth/CachedBluetoothDevice;Z)V

    iput-object v3, p0, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mConnectThread:Lcom/android/settings/bluetooth/CachedBluetoothDevice$ConnectThread;

    .line 309
    iget-object v3, p0, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mConnectThread:Lcom/android/settings/bluetooth/CachedBluetoothDevice$ConnectThread;

    invoke-virtual {v3}, Lcom/android/settings/bluetooth/CachedBluetoothDevice$ConnectThread;->start()V
...
.method private connectInt(Lcom/android/settings/bluetooth/LocalBluetoothProfile;)V
    ...
    const-string v1, "Connection in progress"
...
.method private connectWithoutResettingTimer(Z)V
    ...
    .prologue
    .line 257
    iget-object v4, p0, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mConnectThread:Lcom/android/settings/bluetooth/CachedBluetoothDevice$ConnectThread;
    ...
    const-string v5, "No profiles. Maybe we will connect later"
    ...
    const-string v6, "Preferred profiles = "
    ...
    const-string v5, "Selected no profiles but attempt to connect?!?!"
    ...
    .line 289
    :cond_5
    new-instance v4, Lcom/android/settings/bluetooth/CachedBluetoothDevice$ConnectThread;

    iget-boolean v5, p0, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mConnectAfterPairing:Z

    invoke-direct {v4, p0, v1, p0, v5}, Lcom/android/settings/bluetooth/CachedBluetoothDevice$ConnectThread;-><init>(Lcom/android/settings/bluetooth/CachedBluetoothDevice;Ljava/util/List;Lcom/android/settings/bluetooth/CachedBluetoothDevice;Z)V

    iput-object v4, p0, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mConnectThread:Lcom/android/settings/bluetooth/CachedBluetoothDevice$ConnectThread;

    .line 290
    iget-object v4, p0, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mConnectThread:Lcom/android/settings/bluetooth/CachedBluetoothDevice$ConnectThread;

    invoke-virtual {v4}, Lcom/android/settings/bluetooth/CachedBluetoothDevice$ConnectThread;->start()V
...
.method private isCarkit()Z
    ...
    .line 389
    const-string v0, "Parrot Minikit Slim v1.05"
...
.method private updateProfiles()Z
    ...
    .line 577
    const-string v7, "HANDS FREE"

    iget-object v8, p0, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mName:Ljava/lang/String;
    ...
    invoke-virtual {v7, v6, v4, v8, v9}, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->addNewProfiles([Landroid/os/ParcelUuid;[Landroid/os/ParcelUuid;Ljava/util/Collection;Ljava/util/Collection;)V
    ...
    .restart local v1       #bluetoothClass:Landroid/bluetooth/BluetoothClass;
...
.method connect(Z)V
    ...
    iget-object v0, p0, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mConnectThread:Lcom/android/settings/bluetooth/CachedBluetoothDevice$ConnectThread;
...
.method disconnect()V
    ...
    .prologue
    .line 222
    iget-object v2, p0, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mConnectThread:Lcom/android/settings/bluetooth/CachedBluetoothDevice$ConnectThread;
...
.method onUuidChanged()V
    ...
    const-string v1, "onUuidChanged callback: updateProfiles still fail"
...
.method startPairing()Z
    ...
    const-string v2, "workaround for Mazda!!"
