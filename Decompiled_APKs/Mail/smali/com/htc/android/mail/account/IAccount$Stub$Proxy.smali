.class Lcom/htc/android/mail/account/IAccount$Stub$Proxy;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/htc/android/mail/account/IAccount$Stub;
.end annotation
...
.method constructor <init>(Landroid/os/IBinder;)V
    ...
    .line 1038
    iput-object p1, p0, Lcom/htc/android/mail/account/IAccount$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public alwaysbccMyself()I
    ...
    :try_start_0
    const-string v3, "com.htc.android.mail.account.IAccount"

    invoke-virtual {v0, v3}, Landroid/os/Parcel;->writeInterfaceToken(Ljava/lang/String;)V

    .line 2141
    iget-object v3, p0, Lcom/htc/android/mail/account/IAccount$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public asBinder()Landroid/os/IBinder;
    ...
    .prologue
    .line 1042
    iget-object v0, p0, Lcom/htc/android/mail/account/IAccount$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public commit()V
    ...
    .local v1, _reply:Landroid/os/Parcel;
    :try_start_0
    const-string v2, "com.htc.android.mail.account.IAccount"

    invoke-virtual {v0, v2}, Landroid/os/Parcel;->writeInterfaceToken(Ljava/lang/String;)V

    .line 2827
    iget-object v2, p0, Lcom/htc/android/mail/account/IAccount$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public getDefaultFolderId()J
    ...
    .local v1, _reply:Landroid/os/Parcel;
    :try_start_0
    const-string v4, "com.htc.android.mail.account.IAccount"

    invoke-virtual {v0, v4}, Landroid/os/Parcel;->writeInterfaceToken(Ljava/lang/String;)V

    .line 1796
    iget-object v4, p0, Lcom/htc/android/mail/account/IAccount$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public getMailboxs()Lcom/htc/android/mail/Mailboxs;
    ...
    .line 1777
    sget-object v3, Lcom/htc/android/mail/Mailboxs;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-interface {v3, v1}, Landroid/os/Parcelable$Creator;->createFromParcel(Landroid/os/Parcel;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lcom/htc/android/mail/Mailboxs;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 1784
    .local v2, _result:Lcom/htc/android/mail/Mailboxs;
    :goto_0
    invoke-virtual {v1}, Landroid/os/Parcel;->recycle()V
    ...
    .line 1780
    .end local v2           #_result:Lcom/htc/android/mail/Mailboxs;
    :cond_0
    const/4 v2, 0x0

    .restart local v2       #_result:Lcom/htc/android/mail/Mailboxs;
    goto :goto_0
...
.method public setPollQuantum()V
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
