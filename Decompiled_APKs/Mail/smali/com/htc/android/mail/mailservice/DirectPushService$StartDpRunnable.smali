.class Lcom/htc/android/mail/mailservice/DirectPushService$StartDpRunnable;
...
.method public constructor <init>(ILcom/htc/android/mail/mailservice/DirectPushService;Lcom/htc/android/mail/mailservice/DirectPushService$DirectPushFsmStore;J)V
    ...
    iput v0, p0, Lcom/htc/android/mail/mailservice/DirectPushService$StartDpRunnable;->mStartId:I

    .line 440
    const-wide/16 v0, -0x1

    iput-wide v0, p0, Lcom/htc/android/mail/mailservice/DirectPushService$StartDpRunnable;->mAccountId:J
    ...
    iput-object v0, p0, Lcom/htc/android/mail/mailservice/DirectPushService$StartDpRunnable;->mWeakDirectPushService:Ljava/lang/ref/WeakReference;
    ...
    iput-object v0, p0, Lcom/htc/android/mail/mailservice/DirectPushService$StartDpRunnable;->mContext:Landroid/content/Context;

    .line 445
    iput-object p3, p0, Lcom/htc/android/mail/mailservice/DirectPushService$StartDpRunnable;->mDirectPushFsmStore:Lcom/htc/android/mail/mailservice/DirectPushService$DirectPushFsmStore;

    .line 446
    iput p1, p0, Lcom/htc/android/mail/mailservice/DirectPushService$StartDpRunnable;->mStartId:I

    .line 447
    iput-wide p4, p0, Lcom/htc/android/mail/mailservice/DirectPushService$StartDpRunnable;->mAccountId:J
...
.method public run()V
    ...
    :try_start_0
    iget-object v5, p0, Lcom/htc/android/mail/mailservice/DirectPushService$StartDpRunnable;->mContext:Landroid/content/Context;

    const-string v6, "StartDpRunnable"
    ...
    .line 455
    iget-object v5, p0, Lcom/htc/android/mail/mailservice/DirectPushService$StartDpRunnable;->mDirectPushFsmStore:Lcom/htc/android/mail/mailservice/DirectPushService$DirectPushFsmStore;
    ...
    .line 456
    iget-object v5, p0, Lcom/htc/android/mail/mailservice/DirectPushService$StartDpRunnable;->mWeakDirectPushService:Ljava/lang/ref/WeakReference;
    ...
    iget-object v6, p0, Lcom/htc/android/mail/mailservice/DirectPushService$StartDpRunnable;->mContext:Landroid/content/Context;

    iget-wide v7, p0, Lcom/htc/android/mail/mailservice/DirectPushService$StartDpRunnable;->mAccountId:J
    ...
    invoke-virtual {v3, v1}, Lcom/htc/android/mail/mailservice/DirectPushService$State;->onStartDp(Lcom/htc/android/mail/mailservice/DirectPushService$Fsm;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 468
    const-string v5, "StartDpRunnable"
