.class public Lcom/htc/android/fieldtrial/translator/DataSessionStateTranslator;
.super Lcom/htc/android/fieldtrial/translator/Translator;
.source "DataSessionStateTranslator.java"
...
.method protected getSettingValue(I)Ljava/lang/String;
    ...
    invoke-virtual {v3}, Lcom/htc/android/fieldtrial/dmcmd/DM_HDR_RX_INFO;->getDataSessionState()I

    move-result v1

    .line 19
    .local v1, DataSectionNum:I
    if-ltz v1, :cond_0
    ...
    .line 24
    .local v0, DataSection:Ljava/lang/String;
    :goto_0
    return-object v0

    .line 22
    .end local v0           #DataSection:Ljava/lang/String;
    :cond_1
    ...
    .restart local v0       #DataSection:Ljava/lang/String;
    goto :goto_0
.end method
